...
* @Last Modified time: 2017-05-25 11:43:49
*/
...
class Pay_success extends React.Component{
    constructor(state) {
        super(state);
        ...
        if(this.state.data){
            ...
            return(
                <div>
                    ...
                    <Header text="详情" path="/circle"/>
                    <div className="wrap">
                        <div className="info">
                            <div className="user">
                                <div className="person" onClick={()=>{this.handler(this.state.data.selectedUserId)}}>
                                    <img className="img left clearfix" src={this.state.data?(this.state.data.selectedPortrait?this.state.data.selectedPortrait+'?x-oss-process=image/resize,m_fill,h_200,w_200' : "/static/circle/headportrait64x64@3x.png"):"/static/circle/headportrait64x64@3x.png"} />
                                    <span className="person-type">好心人</span>
                                </div>
                                <div className="user-info">
                                    <p className="location">
                                        <span className="name">{this.state.data?this.state.data.selectedUserName||'-':'-'}</span>
                                        <em>{this.state.data?(this.state.data.isAttentionSelected == 2?'已关注':''):''}</em>
                                        <em className="flag time">借入时间</em>
                                    </p>
                                    <p className="location">
                                        <span>{this.state.data?this.state.data.selectedLocation||'暂无位置信息':'暂无位置信息'}</span>
