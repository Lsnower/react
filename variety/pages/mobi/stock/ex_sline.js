...
export default  class  Sline extends React.Component {
    constructor(props){
                ...
                return v.prototype = {
                    ...
                    resize: function () {
                        ...
                        this.priceChartBox = {
                            ...
                            y: {
                                begin: 2,
                                end: this.svgHeight - 60,
                                height: this.svgHeight -60
                            }
                        },
                        this.volumeChartBox = {
                            x: {
                        ...
                        var o = this,
                            ...
                            k = function(v) {
                                ...
                                _draw = function(el) {
                                    ...
                                    u.push(o._text(a, c, _y + 5, _data.current, '#fff', 'end'));
                     ...
                     _drawBar: function () {
                        ...
                        function (g, t) {
                            ...
                            if (null != p) {
                                ...
                                h = f(p.volume)||u.end - 1,
                                s = e,
                                r = u.end - 1,
                                n = p.current >= v ? o : l,
                                null == i && (n = p.current >= a.close ? o : l),
                                d.push(a._line(m, e, h, s, r, n,'','',0.1)),
                                i = p;
                            }
                        })
                    },
                    ...
                    _line: function (t, e, h, s, n, a, o, l,w) {
                        var c = i.create("line");
                        return i.attr(c, {
                            x1: e,
                            y1: h,
                    ...
                    _limit: function (t, i) {
                        this._last_code === this.code && this._last_time === t.time ?  i.call(this) : i.call(this),
        ...
        this.cacVolume=this.cacVolume.bind(this);
        this.newData={
            gTime:0,
            gVolume:0
        }
